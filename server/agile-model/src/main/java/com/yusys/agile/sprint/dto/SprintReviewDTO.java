...
public class SprintReviewDTO {
    ...
    private List<SprintAttachmentDTO> attachments;
    ...
    public List<SprintAttachmentDTO> getAttachments() {
        return attachments;
    }

    public void setAttachments(List<SprintAttachmentDTO> attachments) {
