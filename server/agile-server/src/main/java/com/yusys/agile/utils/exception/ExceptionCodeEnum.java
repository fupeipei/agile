...
public enum ExceptionCodeEnum {
	PARAM_ERROR(1, "参数异常"), SYS_ERROR(2, "系统异常"), UNAUTHORIZED_ERROR(3, "未登录"), ILLEGALPROJECT_ERROR(4,
			"非法项目"), LOGIN_ERROR(5, "登录错误"),UNACCESS(6,"权限不足"),VERIFYCODE_CREATE_ERROR(7,"生成验证码图片失败!")
	,VERIFYCODE_NULL_ERROR(8,"验证码不能为空!"),VERIFYCODE_TIMEOUT_ERROR(9,"验证码已失效!"),VERIFYCODE_ERROR(10,"验证码错误!"),
