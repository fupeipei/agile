...
public interface SVersionManagerV3Service {
    ...
    PageInfo<SVersionIssueRelateDTO> queryRequirementRelList(Integer pageNum, Integer pageSize, String searchKey, Long teamId, String operateType, Long versionManagerId) throws Exception;
}
