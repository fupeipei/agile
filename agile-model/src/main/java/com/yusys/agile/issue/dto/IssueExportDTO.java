...
/**
 *  @Description: issue导出字段
 *  @author: zhao_yd
 *  @Date: 2021/6/3 5:07 下午
 *
 */
...
public class IssueExportDTO {
    ...
    public String getReallyWorkload() {
        return reallyWorkload;
    }

    public void setReallyWorkload(String reallyWorkload) {
    ...
    public String getAssessIsPass() {
        return assessIsPass;
    }

    public void setAssessIsPass(String assessIsPass) {
    ...
    public String getCmpSyncResult() {
        return cmpSyncResult;
    }

    public void setCmpSyncResult(String cmpSyncResult) {
